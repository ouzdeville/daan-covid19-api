define({ "api": [
  ...
  {
    "type": "post",
    "url": "/selfreport-symptom/create",
    "title": "create self-report-symptom",
    "name": "CreateSelfReportingSymptom",
    "group": "Reporting",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  {
    "type": "post",
    "url": "/selfreport-risk/create",
    "title": "create self-report-risk",
    "name": "createSelfReportRisk",
    "group": "Reporting",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  },
  {
    ...
    "title": "get all risk-factor",
    "name": "getAllRiskFactor",
    "group": "Reporting",
    "success": {
      "fields": {
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "result",
            "description": "<p>risk-factors list</p>"
          }
        ]
      },
      "examples": [
